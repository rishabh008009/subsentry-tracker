...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdrZ2VocHd0d2Jvb3ZicGpscmxsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM0MDI2NDUsImV4cCI6MjA3ODk3ODY0NX0.f9cTwItYHL0X4NvdZFEXNXLVMhx6_d_tZdBoBAfVz20'
...
export const auth = {
  ...
  async signInWithGoogle() {
    const { data, error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: 'https://rishabh008009.github.io/subsentry-tracker/'
      }
    })
    return { data, error }
  },
